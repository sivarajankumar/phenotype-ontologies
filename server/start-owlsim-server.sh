#!/bin/sh
ONT=../src/ontology
OWLTOOLS_MEMORY=14G owltools --catalog-xml $ONT/catalog-v001.xml all.owl --use-fsim  --sim-load-lcs-cache owlsim.cache --sim-load-ic-cache ic-cache.owl --start-sim-server -p 9031
